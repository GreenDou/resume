      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-12 md:py-20 print:py-8 print:px-0">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-6 text-sm text-slate-500 font-mono mb-6">
                <span className="flex items-center gap-2 hover:text-slate-800 transition-colors cursor-pointer"><Mail className="w-4 h-4 text-slate-400" /> zn.he@foxmail.com</span>
                <span className="flex items-center gap-2 hover:text-slate-800 transition-colors cursor-pointer"><Github className="w-4 h-4 text-slate-400" /> github.com/greendou</span>
              </div>

              <div className="flex flex-wrap gap-3 sm:gap-6 text-sm text-slate-600 font-mono">
                <span className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-lg border border-slate-200 shadow-sm"><User className="w-4 h-4 text-slate-400" /> 1992-05</span>
        ...
        >
          ...
          <div className="space-y-4 text-base md:text-lg leading-relaxed text-slate-600 max-w-4xl">
            <p>
              拥有 10 年大前端研发与技术管理经验，深耕 <strong className="text-slate-900 font-medium">大前端架构设计、Web 性能调优及复杂业务系统的工程化治理</strong>。
            </p>
            <p>
              拥有卓越的技术团队领导力，曾管理 <strong className="text-slate-900 font-medium">50 人规模</strong>的跨技术栈团队（涵盖前后端、移动端、Unity等），擅长在复杂业务场景下进行技术选型、效能提升与基础设施建设。
            </p>
            <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="glass-card p-6 group hover:border-emerald-500/30 transition-colors print:shadow-none print:border-slate-300">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="text-lg font-semibold text-slate-900">技术管理与效能提升</h4>
              </div>
              <ul className="space-y-2 text-slate-600 text-sm">
                <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 mt-0.5 text-emerald-500 flex-shrink-0" /> 具备 50 人规模跨技术栈团队管理经验，擅长敏捷迭代与跨部门协同。</li>
                <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 mt-0.5 text-emerald-500 flex-shrink-0" /> 主导公司级前端规范、基础设施建设与核心技术攻坚，显著提升研发效能。</li>
              </ul>
            </div>
            ...
            <div className="glass-card p-6 group hover:border-cyan-500/30 transition-colors print:shadow-none print:border-slate-300">
              ...
              <ul className="space-y-2 text-slate-600 text-sm">
                <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 mt-0.5 text-cyan-500 flex-shrink-0" /> 精通 React, NextJS, TypeScript，具备大型复杂单页应用、Monorepo 治理及跨端架构（Hybrid/RN）经验。</li>
                <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 mt-0.5 text-cyan-500 flex-shrink-0" /> 深入研究前端性能调优，在首屏秒开、SSR 改造、内存泄漏排查及渲染帧率优化方面有丰富实战经验。</li>
              </ul>
            </div>
            ...
            <div className="glass-card p-6 group hover:border-orange-500/30 transition-colors print:shadow-none print:border-slate-300">
              ...
              <ul className="space-y-2 text-slate-600 text-sm">
                <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 mt-0.5 text-orange-500 flex-shrink-0" /> 深入使用 Pixi.js, Fabric.js 构建复杂图形化平台；具备 WebGL / WebGPU 渲染底层演进与性能调优经验。</li>
                <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 mt-0.5 text-orange-500 flex-shrink-0" /> 熟悉 Rust + WGPU + Deno Core (V8) 跨端 3D 引擎架构设计与业务落地。</li>
              </ul>
            </div>
            ...
            <div className="glass-card p-6 group hover:border-purple-500/30 transition-colors print:shadow-none print:border-slate-300">
              ...
              <ul className="space-y-2 text-slate-600 text-sm">
                <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 mt-0.5 text-purple-500 flex-shrink-0" /> 具备将 LLM 能力深度融入复杂交互场景（如 3D 场景编辑）的实战经验，熟练使用 Vercel AI SDK、Zod 构建可靠的结构化对话流。</li>
                <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 mt-0.5 text-purple-500 flex-shrink-0" /> 关注 AI 驱动的研发效能提升与产品创新，能够结合自然语言交互（LUI）与图形用户界面（GUI）打造下一代用户体验。</li>
              </ul>
            </div>
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <div className="relative pl-8 md:pl-0 job-block">
              ...
              {/* PC Timeline Line */}
              <div className="hidden md:block absolute left-[9.5rem] top-2 w-px h-full bg-slate-200" />
              ...
              <div className="flex flex-col md:flex-row gap-3 md:gap-12">
                ...
                <div className="relative flex-1 bg-white p-5 md:p-6 rounded-2xl border border-slate-200 shadow-sm hover:border-slate-300 transition-colors print:shadow-none print:border-slate-300">
                  ...
                  <h4 className="text-xl font-bold text-slate-900 mb-1">3D 引擎团队负责人</h4>
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed mb-4">
                    全面负责公司核心 3D 可编程引擎的研发与演进。管理涵盖前端、移动端、测试及产品的跨职能团队（10人规模）。
                  </p>
                  ...
                  <ul className="space-y-2 text-sm text-slate-600 list-disc list-inside">
                    ...
                    <li><strong className="text-slate-800">团队管理：</strong>统筹迭代计划与任务分配，主导代码评审，提升团队整体工程质量与交付效率。</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="relative pl-8 md:pl-0 job-block">
              ...
              <div className="flex flex-col md:flex-row gap-3 md:gap-12">
                ...
                <div className="relative flex-1 bg-white p-5 md:p-6 rounded-2xl border border-slate-200 shadow-sm hover:border-slate-300 transition-colors print:shadow-none print:border-slate-300">
                  ...
                  <h4 className="text-xl font-bold text-slate-900 mb-1">技术经理 / 前端专家</h4>
                  <h5 className="text-slate-600 mb-4 font-medium">深圳点猫科技有限公司（编程猫）</h5>
                  
                  <ul className="space-y-2 text-sm text-slate-600 list-disc list-inside">
                    <li><strong className="text-slate-800">大团队管理：</strong>负责管理 <strong className="text-emerald-600">50 人规模</strong>的技术团队，统筹前后端、iOS/Android、Unity 及测试等多领域协同。</li>
                    <li><strong className="text-slate-800">核心业务研发：</strong>全面负责编程猫核心创作工具相关产品的技术架构与研发落地，确保高并发、高稳定性的系统实现。</li>
                    <li><strong className="text-slate-800">基建与规范：</strong>兼任技术平台前端专家，制定并统一公司内部各研发团队的前端规范，推动基础设施建设。</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="glass-card p-6 md:p-8 hover:border-slate-300 transition-colors relative overflow-hidden print:shadow-none print:border-slate-300 project-block">
              ...
              <div className="space-y-3 text-sm text-slate-600 mb-6">
                ...
                <p><strong className="text-slate-800">业务成果：</strong>成功支撑应用《单词派对》于 2024年12月 顺利上架应用宝，验证了该技术路线的商业化可行性。</p>
              </div>
            ...
            <div className="glass-card p-6 md:p-8 hover:border-slate-300 transition-colors relative overflow-hidden print:shadow-none print:border-slate-300 project-block">
              ...
              <div className="space-y-3 text-sm text-slate-600 mb-6">
                <p><strong className="text-slate-800">项目背景：</strong>接手 2017 年启动的历史核心项目。接手时团队流失严重（仅剩 1 名全栈），遗留大量未交接内容与技术债。</p>
                ...
                <p><strong className="text-slate-800">SSR 改造：</strong>废弃原有的“后端构建前端代码至容器镜像”的复杂链路，全面迁移至基于 NextJS 的 SSR 架构，显著降低项目运维与开发复杂度。</p>
                <p><strong className="text-slate-800">渲染底层演进：</strong>推动渲染引擎从 WebGL 向 WebGPU 升级；针对移动端性能瓶颈，将动态阴影优化为静态阴影方案，大幅提升渲染帧率。</p>
                <p><strong className="text-slate-800">AI Agent 赋能：</strong>引入大模型能力，构建基于对话的地图编辑 Agent。底层采用 Vercel AI SDK Core 结合 Zod 构建可靠的结构化对话流，前端基于 shadcn/ui (Radix UI + Tailwind CSS) 打造现代化交互组件，实现通过自然语言直接操作 3D 场景的创新体验。</p>
              </div>
              <div className="flex flex-wrap gap-2">
        ...
        <footer className="mt-20 pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-mono text-slate-400 print:hidden">
          <p>© {new Date().getFullYear()} Greendou (He Zhuning). All rights reserved.</p>
          <p>Designed & Coded with React, Tailwind & Framer Motion.</p>
        </footer>
